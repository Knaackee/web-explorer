...
public class SearchClientTests
{
    ...
    public async Task SearchAsync_ThrowsOnNullQuery()
    {
        ...
        using var client = new SearchClient(httpClient);
    ...
    public async Task SearchAsync_WithSiteOption_IncludesSiteInQuery()
    {
        ...
        var options = new SearchOptions { Site = "github.com" };
    ...
    public async Task SearchAsync_UnsafeOption_SendsCorrectFormData()
    {
        ...
        var options = new SearchOptions { SafeSearch = false };
    ...
    public async Task SearchAsync_WithTimeFilter_SendsDf()
    {
        ...
        var options = new SearchOptions { TimeFilter = "w" };
        await client.SearchAsync("test", options);
    ...
    [Fact]
    public void SearchOptions_WithProxy_StoresUri()
    {
        var options = new SearchOptions { Proxy = new Uri("http://proxy:8080") };
    ...
    [Fact]
    public void SearchOptions_Defaults_AreCorrect()
    {
