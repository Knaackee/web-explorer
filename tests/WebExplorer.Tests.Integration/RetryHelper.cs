...
internal static class RetryHelper
{
    ...
    /// Creates a fresh SearchClient for each retry to avoid connection-level blocking.
    /// </summary>
    internal static async Task<SearchResponse> SearchWithRetryAsync(
        Func<Task<SearchResponse>> action,
        int maxAttempts = 3,
