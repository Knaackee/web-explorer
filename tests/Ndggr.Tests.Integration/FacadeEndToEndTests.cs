...
/// <summary>
/// Tests the NdggrClient facade. Search tests use the shared fixture to avoid DDG rate limiting.
...
{
    private readonly NdggrClient _client = new();
    private readonly DdgSearchFixture _fixture;

    public FacadeEndToEndTests(DdgSearchFixture fixture)
    {
        _fixture = fixture;
    }
    ...
    public void SearchAsync_ReturnsSearchResults()
    {
        ...
        // Verify the facade returns the same kind of response as DdgClient
    ...
    public async Task Constructor_WithBothOptions_WorksCorrectly()
    {
        using var client = new NdggrClient(
            new DdgSearchOptions { Region = "us-en" },
