...
/// Writes a full report to tests/Ndggr.Tests.Integration/output/search_and_fetch_report.txt
...
public sealed class SearchAndFetchTests : IDisposable
{
    ...
    public async Task SearchAndFetchAll_WritesReport()
    {
        ...
        // 3. Write output file
        var outputDir = Path.Combine(AppContext.BaseDirectory, "..", "..", "..", "..", "..", "tests", "Ndggr.Tests.Integration", "output");
