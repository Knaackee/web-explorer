...
/// <summary>
/// Base exception for all web-explorer-specific errors.
/// </summary>
public class WebExplorerException : Exception
{
    public WebExplorerException(string message) : base(message) { }
    public WebExplorerException(string message, Exception innerException) : base(message, innerException) { }
}

/// <summary>
/// Thrown when a search request fails due to network or HTTP errors.
/// </summary>
public class SearchException : WebExplorerException
{
